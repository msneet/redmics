...
* <tt>cd /opt/redmine/plugins</tt>
* <tt>git clone https://github.com/buschmais/redmics.git redmine_ics_export</tt>
* <tt>cd /opt/redmine</tt>
* <tt>bundle install --without development test</tt>
